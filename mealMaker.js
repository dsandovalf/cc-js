const menu = {
    ...
    generateRandomMeal(){
      ...
      return `Your meal is ${appetizer.name}, ${main.name}, and ${dessert.name}, and the the toal price is ${totalPrice}`;
    }
  };
  ...
  menu.addDishToCourse('mains', 'chicken tender', 7.00);
  
  menu.addDishToCourse('desserts', 'cake', 3.00);
  menu.addDishToCourse('desserts', 'cookie', 1.50);
  menu.addDishToCourse('desserts', 'flan', 4.00);
